...
#View(weatherAUS)
library(ggplot2)
grafico1 <- ggplot(data=ds, mapping=aes(x=MinTemp, y=MaxTemp)) + geam_point() 
grafico1
#conjunto de datos: data. de ahi saco los datos, y me pide ds

grafico2 <- ggplot(data=ds, mapping=aes(x=MinTemp, y=MaxTemp, color=RainTomorrow)) + geam_point() 
grafico2

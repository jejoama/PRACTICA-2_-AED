...
library(readr)
weatherAUS <- read_csv("data/weatherAUS.RData")
#View(weatherAUS)
...
grafico1
#conjunto de datos: data. de ahi saco los datos, y me pide ds
# lo de geom point es para el grafico de dispersion

grafico2 <- ggplot(data=ds, mapping=aes(x=MinTemp, y=MaxTemp, color=RainTomorrow)) + geom_point() 
grafico2

grafico3 <- ggplot(data=ds, mapping=aes(x=MinTemp, y=MaxTemp, color=RainTomorrow)) + geom_point() + ggtitle("Tabla1")
grafico3
...
load("data/weatherAUS.RData")
ls(ds)
gra1 <- ggplot(data=ds, aes(x=Temp9am, y=Pressure9am)) + geom_point()
gra1 <- ggplot(data=ds, aes(x=Temp9am, y=Pressure9am, shape=RainToday)) + geom_point()
gra1

gra2 <- ggplot(data=ds, aes(x=Temp9am, y=Pressure9am, color=RainToday)) + geom_point()
gra2

gra3 <- ggplot(data=ds, aes(x=Temp9am, y=Pressure9am, color=RainToday)) + geom_point() + labs(title="Hola", subtitle="no se que poner")
gra3 
